artconfig_modules = ['MAIN_PATH', 'OPERATIONAL_MODE', 'RUN_PRE_PROCESSING', 'DAYS_PER_RUN', 'REF_DAYS_TO_START', 'NUMBER_OF_RUNS', 'MODULE', 'RUN_SIMULATION_MODULE', 'RUN_SIMULATION_POST', 'START_DATE', 'END_DATE', 'OUTPUT_TO_FILE', 'OUTPUT_FILEPATH', 'SEND_EMAIL', 'EMAIL']
...
obc_block_modules = ['ENABLE', 'FILE_TYPE', 'SIMULATED_DAYS', 'SUB_FOLDERS', 'DATE_IN_FILENAME', 'DATE_FORMAT', 'FILES', 'WORKPATH']
