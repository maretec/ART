    ...
    if yaml['ARTCONFIG']['OPERATIONAL_MODE']:
        ...
        while cfg.current_final_date <= cfg.global_final_date.replace(minute=00, hour=00, second=00):
            ...
            if (yaml['ARTCONFIG']['MONTH_MODE']):
                ...
                if cfg.current_initial_date.month == 12:
                    cfg.current_final_date = cfg.current_initial_date.replace(day=1,month=1,year=cfg.global_initial_date.year+1, minute=00, hour=00, second=00)
                else:
                    cfg.current_final_date = cfg.current_initial_date.replace(day=1,month=cfg.global_initial_date.month + 1, minute=00, hour=00, second=00)
            else:
